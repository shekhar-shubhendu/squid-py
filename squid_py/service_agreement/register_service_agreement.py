...
def register_service_agreement(web3, contract_path, service_agreement_id, service_definition,
                               *args, **kwargs):
    ...
    watch_service_agreement_events(web3, contract_path, service_agreement_id,
