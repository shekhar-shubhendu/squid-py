...
def register_service_agreement(web3helper, config, service_agreement_id, service_definition,
                               *args, **kwargs):
    ...
    watch_service_agreement_events(web3helper, config, service_agreement_id,
